	...
	return {
		...
		actions: {
			...
			createList: () => {
				...
				fetch(`https://playground.4geeks.com/contact/agendas/X-agenda-X`, {
					method: 'POST',
					headers: {
			...
			getContactList: () => {
				fetch(`https://playground.4geeks.com/contact/agendas/X-agenda-X/contacts`, {
					method: 'GET',
					headers: {
						"Content-Type": "application/json"
					}
			...
			editContact: (event, id) => {
				...
				fetch(`https://playground.4geeks.com/contact/agendas/X-agenda-X/contacts/${id}`, {
					method: 'PUT',
